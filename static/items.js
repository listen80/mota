var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	"items": {
		...
		"book": {
			"cls": "constants",
			"name": "圣光徽",
			"text": "该宝物可以查看怪物的基本情况。使用时按下键盘上的L键便可查看，然后按X键则取消显示。"
		},
		"fly": {
			"cls": "constants",
			"name": "风之罗盘",
			"text": "该宝物可以随意在已经走过的楼层间自由上下。主角可使用J键在已经走过的楼层间进行跳跃。",
			"hideInReplay": true
		},
		"coin": {
			"cls": "constants",
		...
		"cross": {
			"cls": "constants",
			"name": "幸运十字架",
			"text": "把它交给序章中的仙子，可以将自身的所有能力提升一些（攻击、防御和生命值）。"
		},
		"knife": {
			"cls": "constants",
			"name": "屠龙匕首",
		...
		"icePickaxe": {
			"cls": "constants",
			"name": "星光神锒",
			"text": "把它交给第四层的小偷，小偷便会用它打开第十八层的隐藏地面（你就可以救出公主了）。"
		},
		"bomb": {
			"cls": "tools",
			"name": "炸弹",
	...
	"itemEffect": {
		...
		"moneyPocket": "core.status.hero.money += 300",
		"centerFly": "++core.status.hero.lv;core.status.hero.hp+=1000;core.status.hero.atk+=10;core.status.hero.def+=10"
	},
	"itemEffectTip": {
		"redJewel": "'，攻击力加'+core.values.redJewel * ratio",
		"blueJewel": "'，防御力加'+core.values.blueJewel * ratio",
		"greenJewel": "'，魔防+'+core.values.greenJewel * ratio",
		"yellowJewel": "'，全属性提升'",
		"redPotion": "'，生命加'+core.values.redPotion * ratio",
		"bluePotion": "'，生命加'+core.values.bluePotion * ratio",
