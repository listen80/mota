var functions_d6ad677b_427a_4623_b50f_a445a3b0ef8a = 
{
	...
	core.waitHeroToStop(function () {
		...
		// core.setStatus('hp', ...);
		core.drawText([
			"\t[" + (reason || "恭喜通关") + ",hero]你的分数是${status:hp}"
		], function () {
	...
	if (loc == null) {
		...
		stair = (fromIndex <= toIndex) ? "downFloor" : "upFloor";
		// 地下层：同层传送至上楼梯
	...
	if (!(core.material.animates[equipAnimate] || {}).se)
		core.playSound(enemy.special ? enemyId + '.mp3' : 'attack.mp3');
	// 强制战斗的战斗动画
	...
	*/
	...
	// 获得一个道具后触发的事件
	core.playSound(core.material.items[itemId].cls == "constants" || itemId == "superPotion" ? "constants.mp3" : 'item.mp3');
	var todo = [];
	...
	*/
	...
	if (core.status.thisMap.canUseQuickShop === false)
		return '当前楼层禁止访问全局商店！';
	if (core.status.floorId > "MT13" && core.status.floorId < "MT3" && core.status.floorId != "MT2" && !core.hasItem("fly"))
		return "十四楼起必须携带风之罗盘才能访问全局商店！";
	return null;
}
    },
    "enemys": {
	...
	return [
		...
		[10, "模仿", "怪物的攻防和勇士攻防相等"],
		[11, "吸血", function (enemy) { return "战斗前，怪物首先吸取角色的1/" + enemy.value + "生命（" + Math.floor(core.getStatus('hp') / enemy.value) + "点）作为伤害" + (enemy.add ? "，并把伤害数值加到自身生命上" : ""); }],
	...
	if (!core.getBlock(6, 6, "MT16")) {
		core.material.enemys.darkKnight.hp = 1600;
		core.material.enemys.darkKnight.atk = 1306;
		core.material.enemys.darkKnight.def = 1200;
		core.material.enemys.darkKnight.money = 117;
		core.material.enemys.darkKnight.experience = 100;
		core.material.enemys.ghostSkeleton.hp = 3333;
		core.material.enemys.ghostSkeleton.atk = 1200;
		core.material.enemys.ghostSkeleton.def = 1133;
		core.material.enemys.ghostSkeleton.money = 112;
		core.material.enemys.ghostSkeleton.experience = 100;
		core.material.enemys.blackMagician.hp = 2000;
		core.material.enemys.blackMagician.atk = 1106;
		core.material.enemys.blackMagician.def = 973;
		core.material.enemys.blackMagician.money = 106;
		core.material.enemys.blackMagician.experience = 93;
		core.material.enemys.redKing.hp = 20000;
		core.material.enemys.redKing.atk = 1333;
		core.material.enemys.redKing.def = 1333;
		core.material.enemys.redKing.money = 133;
		core.material.enemys.redKing.experience = 133;
	}
	if (!core.getBlock(6, 7, "MT19")) {
		core.material.enemys.vampire.hp = 45000;
		core.material.enemys.vampire.atk = 2550;
		core.material.enemys.vampire.def = 2250;
		core.material.enemys.vampire.money = 312;
		core.material.enemys.vampire.experience = 275;
	}
	if (!core.getBlock(6, 2, "MT21")) {
		core.material.enemys.redKing.hp = 30000;
		core.material.enemys.redKing.atk = 2666;
		core.material.enemys.redKing.def = 2666;
		core.material.enemys.redKing.money = 166;
		core.material.enemys.redKing.experience = 166;
		core.material.enemys.darkKnight.hp = 2400;
		core.material.enemys.darkKnight.atk = 2612;
		core.material.enemys.darkKnight.def = 2400;
		core.material.enemys.darkKnight.money = 146;
		core.material.enemys.darkKnight.experience = 125;
		core.material.enemys.ghostSkeleton.hp = 4999;
		core.material.enemys.ghostSkeleton.atk = 2400;
		core.material.enemys.ghostSkeleton.def = 2266;
		core.material.enemys.ghostSkeleton.money = 140;
		core.material.enemys.ghostSkeleton.experience = 125;
		core.material.enemys.blackMagician.hp = 3000;
		core.material.enemys.blackMagician.atk = 2212;
		core.material.enemys.blackMagician.def = 1946;
		core.material.enemys.blackMagician.money = 132;
		core.material.enemys.blackMagician.experience = 116;
		core.material.enemys.vampire.hp = 60000;
		core.material.enemys.vampire.atk = 3400;
		core.material.enemys.vampire.def = 3000;
		core.material.enemys.vampire.money = 390;
		core.material.enemys.vampire.experience = 343;
	}
	...
	*/
	...
	// 设置等级名称
	core.setStatusBarInnerHTML('lv', core.getLvName() + "级");
